package com.example.orcamentofamiliar.swagger;
...
public class SwaggerConfigurations {
    ...
    public Docket VanApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.example.orcamentofamiliar"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                ...
                "Sistema Gerenciador de despesas e receitas recebidas",
                "1.0",
                "Terms of service",
